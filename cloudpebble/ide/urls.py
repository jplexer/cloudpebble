...
urlpatterns = [
    ...
    re_path(r'^import/github/(?P<github_account>.+?)/(?P<github_project>.+?)$', index, name='index'),
    ...
    re_path(r'^project/(?P<project_id>\d+)/save_settings', save_project_settings, name='save_project_settings'),
    re_path(r'^project/(?P<project_id>\d+)/save_dependencies', save_project_dependencies, name='save_project_dependencies'),
    re_path(r'^project/(?P<project_id>\d+)/delete', delete_project, name='delete_project'),
    re_path(r'^project/(?P<project_id>\d+)/create_source_file', create_source_file, name='create_source_file'),
    re_path(r'^project/(?P<project_id>\d+)/source/(?P<file_id>\d+)/load', load_source_file, name='load_source_file'),
    re_path(r'^project/(?P<project_id>\d+)/source/(?P<file_id>\d+)/save', save_source_file, name='save_source_file'),
    re_path(r'^project/(?P<project_id>\d+)/source/(?P<file_id>\d+)/rename', rename_source_file, name='rename_source_file'),
    re_path(r'^project/(?P<project_id>\d+)/source/(?P<file_id>\d+)/is_safe', source_file_is_safe, name='source_file_is_safe'),
    re_path(r'^project/(?P<project_id>\d+)/source/(?P<file_id>\d+)/delete', delete_source_file, name='delete_source_file'),
    re_path(r'^project/(?P<project_id>\d+)/create_resource', create_resource, name='create_resource'),
    re_path(r'^project/(?P<project_id>\d+)/resource/(?P<resource_id>\d+)/info', resource_info, name='resource_info'),
    re_path(r'^project/(?P<project_id>\d+)/resource/(?P<resource_id>\d+)/delete', delete_resource, name='delete_resource'),
    re_path(r'^project/(?P<project_id>\d+)/resource/(?P<resource_id>\d+)/update', update_resource, name='update_resource'),
    re_path(r'^project/(?P<project_id>\d+)/resource/(?P<resource_id>\d+)/(?P<variant>\d+(?:,\d+)*)/get', show_resource, name='show_resource'),
    re_path(r'^project/(?P<project_id>\d+)/resource/(?P<resource_id>\d+)/(?P<variant>\d+(?:,\d+)*)/delete', delete_variant, name='delete_variant'),
    re_path(r'^project/(?P<project_id>\d+)/build/run', compile_project, name='compile_project'),
    re_path(r'^project/(?P<project_id>\d+)/build/last', last_build, name='get_last_build'),
    ...
    re_path(r'^project/(?P<project_id>\d+)/github/commit$', github_push, name='github_push'),
    re_path(r'^project/(?P<project_id>\d+)/github/pull$', github_pull, name='github_pull'),
    re_path(r'^project/(?P<project_id>\d+)/github/push_hook$', github_hook, name='github_hook'),
    re_path(r'^project/(?P<project_id>\d+)/status\.png$', build_status, name='build_status'),
    re_path(r'^project/(?P<project_id>\d+)/autocomplete/init', init_autocomplete, name='init_autocomplete'),
    re_path(r'emulator/launch', launch_emulator, name='launch_emulator'),
    re_path(r'emulator/config', qemu_config, name='qemu_config'),
    re_path(r'emulator/(?P<emulator_id>[0-9a-f-]{32,36})/mobile_token', generate_phone_token,  name='qemu_mobile_token'),
    re_path(r'emulator/token/(?P<token>\d{6})', handle_phone_token,  name='qemu_mobile_token'),
    ...
    re_path(r'^settings/github/callback$', complete_github_auth, name='complete_github_auth'),
