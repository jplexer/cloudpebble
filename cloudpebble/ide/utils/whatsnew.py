NEW_THINGS = [
    ...
    ["CloudPebble now lets you create appications using pure JavaScript! <a href='https://developer.repebble.com/blog/2014/03/14/CloudPebble-now-supports-Simplyjs/' target='_blank'>Check out our blog post!</a>"],
    ...
    ["iOS users can now more easily install apps on their phones by selecting it from a list!",
     ...
     "<a href='https://developer.repebble.com/blog/2014/04/04/Easier-app-deployment-from-Cloudpebble/' target='_blank'>See the blog post!</a>"],
    ...
    ["CloudPebble is now running Pebble SDK 2.1. See the <a href='https://developer.repebble.com/2/changelog-2.1.html'>full release notes</a>.",
     ...
     "Apps built on CloudPebble now require you to <a href='https://developer.repebble.com/2/getting-started/'>update to Pebble OS 2.1</a> to run your apps."],
    ["CloudPebble now supports import, export, and GitHub pull/push for Simply.js and Pebble.js (beta) projects."],
    ["CloudPebble is now using SDK 2.4; check out <a href='https://developer.repebble.com/2/changelog-2.4.html' target='_blank'>release notes</a>."],
    ["CloudPebble now feature a UI builder for native apps! Learn more <a href='https://developer.repebble.com/blog/2014/08/08/CloudPebble-Graphical-UI-Editor/' target='_blank'>on our blog</a>."],
    ["CloudPebble is now running SDK 2.5!",
     "New features include <a href='https://developer.repebble.com/2/guides/compass.html' target='_blank'>compass support</a>, heap state APIs, and emoji in system fonts <code>GOTHIC_24_BOLD</code>, <code>GOTHIC_18</code> and <code>GOTHIC_18_BOLD</code>.",
     "Check out <a href='https://developer.repebble.com/2/changelog-2.5.html' target='_blank'>the full release notes</a>."],
    ["CloudPebble is now running SDK 2.6!",
     "You can now build apps that run in the background. Check out our <a href='https://developer.repebble.com/2/guides/background-guide.html'>background guide</a> for more details.",
     "Other new features include access to the watch colour, firmware version, and framebuffer. Check <a href='https://developer.repebble.com/2/changelog-2.6.html'>the release notes</a> for more details."],
    ["Significantly improved code completion!",
     ...
     "Check out <a href='https://developer.repebble.com/blog/2014/10/09/CloudPebble-code-completion/' target='_blank'>the blog post</a> for details and examples!"],
    ...
    ["Introducing Pebble Round! CloudPebble has been upgraded to support the new platform (Chalk) and its SDK.",
     ...
     "See <a href=\"http://developer.repebble.com/sdk/round-getting-started/\">this guide</a> for more information"],
    ...
    ["CloudPebble has been updated to SDK 3.8! Aplite now uses SDK 3. Read more <a href='https://developer.repebble.com/blog/2015/12/02/Bringing-the-Family-Back-Together/'>on our blog</a>.",
     "We have converted all your png and pbi resources to the new 'bitmap' format. Read more <a href='https://developer.repebble.com/blog/2015/12/02/Bitmap-Resources/'> on our blog</a>."],
    ["Pebble.js can now build Chalk apps for Pebble Time Round. You can enable this in the settings of your pebble.js project."],
    ["We now have support for using packages, enabling easier code sharing! Check out <a href='https://developer.repebble.com/blog/2016/06/07/pebble-packages/'>our blog post</a>."],
    ...
    ["Write watchfaces with <a href='https://developer.repebble.com/blog/2016/08/15/introducing-rockyjs-watchfaces/'>JavaScript on the Freakin' Watch</a>!"],
]
